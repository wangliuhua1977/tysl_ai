...
public partial class PreviewHostControl : UserControl, IDisposable
{
    ...
    private static string BuildPlaybackDiagnosticMessage(JsonElement payload)
    {
        ...
        AppendValue(parts, payload, "type");
        ...
        AppendValue(parts, payload, "sampleCount");
        AppendValue(parts, payload, "startPts");
        AppendValue(parts, payload, "endPts");
        ...
        AppendValue(parts, payload, "levelCodecs");
        AppendValue(parts, payload, "audioCodec");
        AppendValue(parts, payload, "videoCodec");
        AppendValue(parts, payload, "audioContainer");
        AppendValue(parts, payload, "videoContainer");
        AppendValue(parts, payload, "totalDuration");
        AppendValue(parts, payload, "audioCodecSupported");
        AppendValue(parts, payload, "videoCodecSupported");
        AppendValue(parts, payload, "errorMessage");
        AppendValue(parts, payload, "sourceBufferUpdating");
        AppendValue(parts, payload, "manifestParsed");
        AppendValue(parts, payload, "fragParsedCount");
        AppendValue(parts, payload, "levelAudioCodec");
        AppendValue(parts, payload, "levelVideoCodec");
        AppendValue(parts, payload, "levelTotalDuration");
        AppendValue(parts, payload, "levelFragments");
        AppendValue(parts, payload, "mediaSourceOpenCount");
        AppendValue(parts, payload, "mediaSourceEndedCount");
        AppendValue(parts, payload, "mediaSourceCloseCount");
        AppendValue(parts, payload, "audioSourceBufferCount");
        AppendValue(parts, payload, "videoSourceBufferCount");
        AppendValue(parts, payload, "unknownSourceBufferCount");
        AppendValue(parts, payload, "audioSourceBufferMimeType");
        AppendValue(parts, payload, "videoSourceBufferMimeType");
        AppendValue(parts, payload, "unknownSourceBufferMimeType");
        AppendValue(parts, payload, "sourceBufferUpdateStartCount");
        AppendValue(parts, payload, "sourceBufferUpdateEndCount");
        AppendValue(parts, payload, "sourceBufferErrorCount");
        AppendValue(parts, payload, "audioInitSegmentSeen");
        AppendValue(parts, payload, "videoInitSegmentSeen");
        AppendValue(parts, payload, "audioSamplesParsed");
        AppendValue(parts, payload, "videoSamplesParsed");
        AppendValue(parts, payload, "audioFragBufferedCount");
        AppendValue(parts, payload, "videoFragBufferedCount");
        AppendValue(parts, payload, "unknownFragBufferedCount");
        AppendValue(parts, payload, "audioAppendCount");
        AppendValue(parts, payload, "videoAppendCount");
        AppendValue(parts, payload, "unknownAppendCount");
        AppendValue(parts, payload, "audioAppendBytes");
        AppendValue(parts, payload, "videoAppendBytes");
        AppendValue(parts, payload, "unknownAppendBytes");
        AppendValue(parts, payload, "lastErrorType");
        AppendValue(parts, payload, "lastErrorDetail");
        AppendValue(parts, payload, "lastErrorReason");
        AppendValue(parts, payload, "lastErrorMessage");
        AppendValue(parts, payload, "lastSourceBufferType");
        AppendValue(parts, payload, "lastSourceBufferMimeType");
        AppendValue(parts, payload, "lastSourceBufferError");
        AppendValue(parts, payload, "lastVideoBlockage");
