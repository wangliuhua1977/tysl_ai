...
public sealed class SiteMapQueryService : ISiteMapQueryService
{
        ...
        PlatformConnectionState platformConnectionState)
    {
        ...
        return new SiteMergedView
        {
            ...
            DefaultDispatchRemark = localProfile?.DefaultDispatchRemark,
            IsAutoDispatchEnabled = localProfile?.IsAutoDispatchEnabled ?? false,
            AllowRecoveryAutoArchive = localProfile?.AllowRecoveryAutoArchive ?? false,
            RecoveryConfirmationMode = localProfile?.RecoveryConfirmationMode ?? RecoveryConfirmationMode.ManualOnly,
